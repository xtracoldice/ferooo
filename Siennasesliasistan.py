...
# pip install gTTS  pip install playsound pip install lxml pip install SpeechRecognition pip install PyAudio pip install feedparser pip install colorama install pyinstaller
# https://chromedriver.storage.googleapis.com/index.html?path=84.0.4147.30/ chrome driver 
#ses sorunu cözümü  pip uninstall playsound   pip install playsound==1.2.2
...
def record(ask = False):#record adlı bir fonksiyon oluşturuyoruz ve varsayılan olarak ask =false olarak ayarlıyouz
    with sr.Microphone() as source: #mikrofandan gelen veriyi işlem yapabilmek için source e tanımlıyoruz
        ...
        try:#
            ...
            print(Fore.GREEN)
            print("Sienna  = ne dedin, anlamadım , acaba tekrar edermisin")
            ...
            print(Fore.GREEN)
            print('Sienna  = Sistemin çalışmıyor')
...
def response(voice):#voice ile gelen veriyi sorgululamak için response adında bir fonkiyon
    ...
    if 'iyiyim' in voice:# eğer voice nin içinde iyiyim diye bir değer varsa bunları yap
        print(Fore.GREEN)
        print("Sienna  = iyi olmana sevindim senin için ne yapabilirim")#ekrana yazılacak veri
    ...
    if 'kötüyüm'  in voice:# eğer voice nin içinde kötüyüm diye bir değer varsa bunları yap
        ...
        print(Fore.GREEN)
        print("Sienna  = "+secimolumsuz)#seçilen söz ekrana yazılması için
    ...
    if 'fıkra anlat' in voice:# eğer voice nin içinde Fıkra anlat diye bir değer varsa bunları yap
        ...
        fıkralar = ["Temel'in eldivenle yazı yazdığını görenler sormuş. Niye eldivenli yazıyorsun zor olmuyor mu? Zorluğuna zor ama el yazımın tanınmasını istemeyrum.",
        ...
        print(Fore.GREEN)
        print("Sienna  = "+secimfık)#seçilen söz ekrana yazılması için
    ...
    if 'hikaye anlat' in voice:# eğer voice nin içinde hikaye anlat diye bir değer varsa bunları yap
        ...
        print(Fore.GREEN)
        print("Sienna  = "+secimhikaye)#seçilen hikaye ekrana yazılması için
    ...
    if 'sen kimsin'  in voice:# eğer voice nin içinde sen kimsin diye bir değer varsa bunları yap
        print(Fore.GREEN)
        speak('Benim adım Sienna ben bir asistanım  ')#selendirelecek
        print('Sienna  = Benim adım Sienna ben bir asistanım')#ekrana yazılacak
    ...
    if 'saat kaç' in voice:# eğer voice nin içinde saat kaç diye bir değer varsa bunları yap
        ...
        print(Fore.GREEN)
        print("Sienna  = "+datetime.now().strftime('%H:%M:%S'))#datetime.now sayesinde anlık saati alıyoruz ve yazdırıyoruz
    ...
    if 'arama yap' in voice:# eğer voice nin içinde arama yap diye bir değer varsa bunları yap
        ...
        print(Fore.GREEN)
        print("Sienna  = "+search+' için bulduğum sonuçlar')#ekrana yazdırma yapıyouz
    ...
    if 'hava durumu' in voice:# eğer voice nin içinde hava durumu diye bir değer varsa bunları yap
        ...
        print(Fore.GREEN)
        print("Sienna  = "+havail+" için hava"+havadetay+" derece")#ekrana yazdırıyouz
    ...
    if 'güle güle' in voice:# eğer voice nin içinde güle güle diye bir değer varsa bunları yap
        ...
        print(Fore.GREEN)
        print('Sienna  = görüşürüz')#ekrana yazdırıyouz
...
print(Fore.GREEN)
print('Sienna  = Seni dinliyorum Senin için ne yapabilirim')#ilk açılışta asiatanın bizi karşılamasını yazdırmak için
